...
(function() {
  ...
  exports.Class = SyncTubeServerChannel = class SyncTubeServerChannel {
    ...
    CHSCMD_pause(client) {
      if (!(this.control.indexOf(client) > -1)) {
        return this.permissionDenied(client, "pause");
      }
    ...
    CHSCMD_resume(client) {
      if (!(this.control.indexOf(client) > -1)) {
        return this.permissionDenied(client, "resume");
      }
      this.desired.state = "play";
      this.broadcastCode(false, "desired", this.desired);
      return client.ack();
    ...
    CHSCMD_toggle(client) {
      if (!(this.control.indexOf(client) > -1)) {
        return this.permissionDenied(client, "toggle");
      }
    ...
    CHSCMD_play(client, url) {
      var m;
      if (!(this.control.indexOf(client) > -1)) {
        return this.permissionDenied(client, "play");
      }
    ...
    CHSCMD_host(client, who) {
      ...
      if (!(this.control.indexOf(client) > -1)) {
        return this.permissionDenied(client, "host");
      }
